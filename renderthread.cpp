...
void RenderThread::render(int width, int height, bool overlay, std::string file1, std::string file2, QColor lnColor, QColor flColor, QColor bgColor)
{
...
void RenderThread::run() {
        ...
        gerbv_open_layer_from_filename_with_color(mainProject, const_cast<gchar*>(_file1.c_str()), lnColor.gtk()->r(), lnColor.gtk()->g(), lnColor.gtk()->b(), lnColor.gtk()->a());
        if (_overlay) {
            gerbv_open_layer_from_filename_with_color(mainProject, const_cast<gchar*>(_file2.c_str()), flColor.gtk()->r(), flColor.gtk()->g(), flColor.gtk()->b(), flColor.gtk()->a());
        }
